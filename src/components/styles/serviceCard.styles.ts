export const SERVICE_CARD_CLASSES = {
  card:
  ...
  iconBox:
    "mb-5 flex h-11 w-11 items-center justify-center rounded-2xl border border-cyan-300/30 bg-cyan-300/10 sm:mb-6 sm:h-12 sm:w-12",
  icon: "h-5 w-5 text-cyan-200 sm:h-6 sm:w-6",
  title: "text-lg font-semibold text-white sm:text-xl",
  secondaryTitle: "mt-2 text-sm font-semibold tracking-wide text-cyan-200/90",
