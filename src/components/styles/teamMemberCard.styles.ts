export const TEAM_MEMBER_CARD_CLASSES = {
  card:
    "glow-hover rounded-3xl border border-white/10 bg-gradient-to-b from-slate-900/90 to-slate-950 p-5 shadow-[0_8px_40px_rgba(2,6,23,0.45)] max-[430px]:p-[1.125rem] sm:p-7",
  avatarBox:
    "mb-4 flex h-14 w-14 items-center justify-center overflow-hidden rounded-2xl border border-cyan-300/20 bg-cyan-300/10 sm:mb-5 sm:h-16 sm:w-16",
  ...
  skillsWrapper: "mt-4 flex flex-wrap gap-2 sm:mt-5",
  skill:
