export const CONTACT_SECTION_CLASSES = {
  ...
  badgeIcon: "h-4 w-4",
  title:
    "mt-5 text-balance text-2xl font-semibold leading-[1.25] text-white sm:mt-6 sm:text-3xl lg:text-4xl",
  description:
  ...
  value: "mt-3 text-base font-semibold text-cyan-100 sm:text-lg",
  primaryLink:
