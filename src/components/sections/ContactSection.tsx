...
export function ContactSection() {
  return (
    <section id="contact" className="px-4 py-16 sm:px-6 sm:py-24 lg:py-28">
      <div className="mx-auto max-w-5xl overflow-hidden rounded-[2.2rem] border border-cyan-300/20 bg-gradient-to-br from-cyan-900/20 via-slate-900 to-slate-950 p-6 shadow-[0_20px_100px_rgba(14,116,144,0.28)] sm:p-12">
        <div className="grid items-center gap-8 sm:gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <h2 className="mt-5 text-balance text-2xl font-semibold text-white sm:mt-6 sm:text-5xl">
