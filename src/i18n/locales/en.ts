...
export const enContent: SiteContent = {
  ...
  languageSwitcher: { ariaLabel: "Change website language" },
  hero: {
  ...
  techStackSection: {
    ...
    categoryMeta: {
      "Frontend & Mobile": { shortTitle: "Frontend", description: "Building fast, responsive and accessible interfaces." },
      "Backend & APIs": { shortTitle: "Backend", description: "Robust server-side logic and APIs." },
      "Database & Systems": { shortTitle: "Database", description: "Secure, scalable and high-performance data." },
      "Cloud & DevOps": { shortTitle: "Cloud & DevOps", description: "Infrastructure, deployment and automation." },
    },
    closingNote: "We continuously explore and adopt new technologies to deliver better solutions.",
  },
  architectureSection: {
    ...
    items: [
      { title: "Microservices", description: "Domain-driven service boundaries that support independent scaling and change velocity.", iconKey: "blocks", appliedIn: "EquiTip Modernization" },
      { title: "API Gateway", description: "Centralized traffic control with policy enforcement, observability, and secure exposure.", iconKey: "network", appliedIn: "EquiTip API Gateway Architecture" },
      { title: "Identity & Auth", description: "Enterprise access control with JWT, RBAC, and explicit permission boundaries.", iconKey: "key", appliedIn: "All Projects" },
      { title: "Secure Services", description: "Defense-in-depth backend patterns with validation, hardening, and risk-aware defaults.", iconKey: "shield", appliedIn: "AI Fall Protection Plan & PathPal Platform" },
      { title: "Modern Deployment", description: "Production-ready deployment workflows using GitHub, Docker, Railway, AWS, and Azure.", iconKey: "cloudCog", appliedIn: "EquiTip Modernization" },
      { title: "Delivery Workflow", description: "Execution frameworks that keep scope, quality, and timeline aligned to business goals.", iconKey: "workflow", appliedIn: "All Projects" },
    ],
  },
  teamSection: {
    eyebrow: "Team",
    ...
    members: [
      { name: "Haider Al-Sudani", imageUrl: "/team/haider.png", role: "Founder | Full-Stack Developer | Backend Architecture", summary: "Founder of SystemForge Studio. Leads solution architecture, backend strategy, delivery planning, and stakeholder communication for end-to-end execution.", skills: ["Founder", "Backend", "Architecture", "React Native", "Node.js", "PostgreSQL"] },
      { name: "Haven Zhang", imageUrl: "/team/haven.png", role: "Full-Stack Developer | Enterprise Applications", summary: "Enterprise software developer with 7 years of experience delivering solutions for NEC client projects and modern full-stack applications.", skills: ["System Design", "Enterprise", ".NET", "React", "Node.js", "Oracle"] },
      { name: "Jimmy Kong", imageUrl: "/team/jimmy.png", role: "Mobile Developer", summary: "Independent developer of mobile app Rentamin. AWS Certified Solutions Architect with strong knowledge of the cloud ecosystem. Actively uses AI to improve development productivity.", skills: ["Go", "TypeScript", "AWS", "React Native", "Next.js", "Web Animations", "CSS"] },
      { name: "Lin Pan", imageUrl: "/team/lin.jpg", role: "Full-Stack Developer | Business Systems Specialist", summary: "Full-stack developer experienced in building web, mobile, and backend systems. Combines enterprise consulting and software engineering to deliver scalable business solutions.", skills: ["React", "TypeScript", "Node.js", "MongoDB", "System Design", "Business Analysis", "AI Integration", "Tax Technology", "Process Automation"] },
      { name: "Jerry Xing", imageUrl: "/team/jerry.png", role: "Full-Stack Developer", summary: "Full-stack developer focused on backend implementation and API integration. Contributes to service development, database-related work, authentication flows, and project documentation.", skills: ["Vue.js", "React", "Node.js", "C#", "Java", "Oracle", "MongoDB", "PostgreSQL", "Git Workflow"] },
    ],
  },
  contactSection: {
    ...
    channels: [
      { label: "Email", value: "haider.alsudani.dev@gmail.com", href: "mailto:haider.alsudani.dev@gmail.com", isPrimary: true },
      { label: "GitHub", value: "systemforge-studio", href: "https://github.com/systemforge-studio" },
    ],
  },
  footer: {
    ...
    links: [
      { label: "GitHub", value: "systemforge-studio", href: "https://github.com/systemforge-studio" },
      { label: "Email", value: "haider.alsudani.dev@gmail.com", href: "mailto:haider.alsudani.dev@gmail.com" },
    ],
  },
};
